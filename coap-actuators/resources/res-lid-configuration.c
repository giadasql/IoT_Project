...
static sensor_config_t lid_sensor = {"", {}, "lid_sensor", "/lid/config"};
static sensor_config_t scale_sensor = {"", {}, "scale_sensor", "/scale/config"};
static sensor_config_t waste_level_sensor = {"", {}, "waste_level_sensor", "/waste/config"};
